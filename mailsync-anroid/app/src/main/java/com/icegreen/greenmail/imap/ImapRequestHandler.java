...
public final class ImapRequestHandler {
    ...
    public boolean handleRequest(InputStream input,
                                 OutputStream output,
                                 ImapSession session)
        throws ProtocolException, IOException, ClassNotFoundException {
    ...
    private void doProcessRequest(ImapRequestLineReader request,
                                  ...
                                  ImapSession session) throws IOException, ClassNotFoundException {
        String tag;
        String commandName;
...
//      debug
        System.out.println("C: tag=" + tag + ", command=" + commandName);
        request.dumpLine();
...
//        String a = command.getExpectedMessage();
