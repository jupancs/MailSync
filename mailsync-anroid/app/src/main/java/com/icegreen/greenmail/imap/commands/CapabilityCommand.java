...
class CapabilityCommand extends CommandTemplate {
  ...
  protected void doProcess(ImapRequestLineReader request,
    ...
    if (selectedNetwork == 2) {
      // Using local service
      System.out.println("local service_ capability response: " + CAPABILITY_RESPONSE);
      ...
      ExternalProxy.expressInterest("/mailSync/emailsynctest1@gmail.com/inbox/1/CAPABILITY/1");
      ...
      String capabilityResponse = ExternalProxy.getContentString();
      System.out.println("capabilityResponse: " + capabilityResponse);

      response.untaggedResponse("CAPABILITY " + capabilityResponse);
