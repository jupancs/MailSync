 ...
 */
public class HierarchicalFolder implements MailFolder, UIDFolder, Serializable {
    private static final Flags PERMANENT_FLAGS = new Flags();
    private Set<String> messgeSet = new HashSet<>();
    ...
    @Override
    public long appendMessageNDN(MimeMessage message,
                              Flags flags,
                              Date receivedDate,
                              Context context) {
        long uid = nextUid;
...
//        try {
//            TranslateWorker.start(storedMessage, context);
