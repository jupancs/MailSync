...
public class ImapSessionFolder implements MailFolder, FolderListener, UIDFolder, Serializable {
    ...
    @Override
    public long appendMessageNDN(MimeMessage message, Flags flags, Date receivedDate, Context context) {
        return 0;
    }
