...
//    }
    ...
    public void doProcess(ImapRequestLineReader request,
        ...
        System.out.println("I am in Search Command!");
        ...
        parser.endLine(request);
//
//        System.out.println("Search term is: >>>>>>>>>> " + searchTerm.toString());
//
//        IMAPFolder folder = NdnFolder.folder;
////        long[] uids = NdnFolder.messageUids;
//        long[] uids = NdnFolder.search(searchTerm);
//        StringBuilder idList = new StringBuilder();
//        for (int i = 0; i < uids.length; i++) {
//            if (i > 0) {
//                idList.append(SP);
