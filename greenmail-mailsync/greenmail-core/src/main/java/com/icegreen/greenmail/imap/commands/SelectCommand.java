...
//  }
  ...
  protected void doProcess(ImapRequestLineReader request,
    ...
    Snapshot snapshot = NDNMailSyncConsumerProducer.mailbox;
    ...
    System.out.println("Select Command - Recent: " + snapshot.recent + ", Exits: " + snapshot.exists);
