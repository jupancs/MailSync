...
public class RegisterRoute {
  ...
  private final ByteBuffer DEFAULT_RSA_PUBLIC_KEY_DER = toBuffer(new int[] {
  ...
  private final ByteBuffer DEFAULT_RSA_PRIVATE_KEY_DER = toBuffer(new int[] {
  ...
  public void
  run() throws EncodingException
  {
    try {
      final Name prefix = new Name("/mailSync");
      // Route to aleph.ndn.ucla.edu.  Have to use the canonical name with
      // an IP address and port.
//      final String uri = "udp4://224.0.23.170:56363";
      final String uri = "udp4://192.168.43.1:6363";
