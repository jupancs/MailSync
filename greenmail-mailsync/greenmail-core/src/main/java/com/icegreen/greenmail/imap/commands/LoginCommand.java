...
import static com.icegreen.greenmail.ExternalProxy.IpMailServiceLogin;
...
//        IpMailServiceLogin(session, userid, password);
...
//        ExternalProxy.ipmail.login("imap.gmail.com", userid, password);
    }
}
